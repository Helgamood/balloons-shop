              ...
              <nav class="header__burger-nav">
                <ul class="header__burger-list">
                  <li class="header__burger-item">
                    <a href="#" target="_blank" class="header__item-text">Акции</a>
                      <button class="header__btn-close">
                        <img src="./src/images/header/btn-close.svg" alt="button close">
                      </button>
                    </li>
                    <li class="header__burger-item">
                      <a href="#" target="_blank" class="header__item-text">Контакты</a>
                    </li>
                    <li class="header__burger-item">
                      <a href="#" target="_blank" class="header__item-text">Галерея</a>
                    </li>
                    <li class="header__burger-item">
                      <a href="#" target="_blank" class="header__item-text">Отзывы</a>
                    </li>
                    <li class="header__burger-item">
                      <a href="#" target="_blank" class="header__item-text">Доставка</a>
                    </li>
                  </ul>
                  ...
                  <ul class="header__burger-list header__burger-list_2">
                    <li class="header__burger-item header__burger-item_2">
                      ...
                      <a class="header__number" href="tel:+78612042446">+7 861 204 24 46</a>
                    </li>
                    <li class="header__burger-item header__burger-item_2">
                      <p class="header__item-title">Мы в соц. сетях</p>
                      <div class="header__socials-wrap">
                        <a class="header__social-link" href="instagram.com" target="_blank">
                        ...
                        <a class="header__social-link" href="whatsapp.com" target="_blank">
                          <svg width="50" height="50" viewBox="0 0 50 50" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <header class="header header-desktop" >
      <div class="header__container container">
        ...
        <div class="header__main">
          ...
          <ul class="header__burger-list">
            <li class="header__burger-item">
              <a href="#" target="_blank" class="header__item-text item-text_active ">Акции</a>
            </li>
            <li class="header__burger-item">
              <a href="#" target="_blank" class="header__item-text">Контакты</a>
            </li>
